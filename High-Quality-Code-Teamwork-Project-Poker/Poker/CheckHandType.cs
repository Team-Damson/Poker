...
namespace Poker
{
    public class CheckHandType
    {
        ...
        public void rStraightFlush(ref double current, ref double Power, int[] st1, int[] st2, int[] st3, int[] st4,ref List<Type> Win,ref Type sorted)
        {
            if (current >= -1)
            {
                if (st1.Length >= 5)
        ...
        public void rFourOfAKind(ref double current, ref double Power, int[] Straight, ref List<Type> Win, ref Type sorted)
        {
            if (current >= -1)
            {
                for (int j = 0; j <= 3; j++)
        ...
        public void rFullHouse(ref double current, ref double Power, ref bool done, int[] Straight, ref List<Type> Win, ref Type sorted,ref double type)
        {
            if (current >= -1)
            {
                type = Power;
        ...
        public void rFlush(ref double current, ref double Power, ref bool vf, int[] Straight1, ref List<Type> Win, ref Type sorted, ref int[] Reserve, int i)
        {
            if (current >= -1)
            {
        ...
        public void rStraight(ref double current, ref double Power, int[] Straight, ref List<Type> Win, ref Type sorted)
        {
            if (current >= -1)
            {
        ...
        public void rThreeOfAKind(ref double current, ref double Power, int[] Straight, ref List<Type> Win, ref Type sorted)
        {
            if (current >= -1)
            {
                for (int j = 0; j <= 12; j++)
        ...
        public void rTwoPair(ref double current, ref double Power, ref List<Type> Win, ref Type sorted, ref int[] Reserve, int i)
        {
            if (current >= -1)
            {
                bool msgbox = false;
        ...
        public void rPairTwoPair(ref double current, ref double Power, ref List<Type> Win, ref Type sorted, ref int[] Reserve,int i)
        {
            if (current >= -1)
            {
                bool msgbox = false;
        ...
        public void rPairFromHand(ref double current, ref double Power, ref List<Type> Win, ref Type sorted, ref int[] Reserve, int i)
        {
            if (current >= -1)
            {
                bool msgbox = false;
        ...
        public void rHighCard(ref double current, ref double Power, ref List<Type> Win, ref Type sorted, ref int[] Reserve, int i)
        {
            if (current == -1)
            {
                if (Reserve[i] / 4 > Reserve[i + 1] / 4)
